...
import ru.job4j.repository.postgresrepo.specs.MusicTypesGetterSpec;
...
public class CreateUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (factory != null) {
            ...
            if (!users.contains(user)) {
                factory.getUserRepository().add(user);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AbstractFactory factory = AbstractFactory.getFactory(factoryID);
        if (factory != null) {
            List<MusicType> musicTypes = factory.getMusicTypeRepository().querry(new MusicTypesGetterSpec());
